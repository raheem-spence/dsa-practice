class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        # Time: O(n + m), one pass over each string n and string m
        # Space: O(1) space is constant since there are only 26 letters in alphabet
        # and the dict size is determined by the amount of key:value pairs and we 
        # can at most have 26 no matter how big input gets
